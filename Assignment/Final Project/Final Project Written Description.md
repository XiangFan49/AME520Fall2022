...
<img src="https://github.com/XiangFan49/AME520Fall2022/raw/main/Assignment/Final%20Project/Previous%20Work%20Display.png" width="42%"> <img src="https://github.com/XiangFan49/AME520Fall2022/raw/main/Assignment/Final%20Project/Shader%20Node%20Display.png" width="54%">
...
## Project Future Plan (In Order of Priority):
...
* Familiar with the use of shaders in Unity to optimize the non-photorealistic rendering of models
* Add physical effect attributes to models and objects in the scene

## Final Vision for Future Outlook
* The final appearance of the project will allow participants to wear VR headsets to experience their own virtual avatar in the digital world using NPR rendering so that during general motion, participants will experience how they look when they move in a two-dimensional space. In addition, the purpose-built pre-designed space will further explore participants' perception of optical illusions in the digital space and examine its differences and similarities with the physical world. 
* In this process, the motion capture part will be performed by the VR device and represented by the data set generated by the AI ​​machine learning algorithm. In this way, although part of the accuracy of motion capture is lost, it gives participants more space for free movement. On the other hand, the preset digital scene will be a street with a slope, and the environmental hints in it will make the participants think they are walking in a plane. We can match it to the situation in the physical environment or make parallel comparisons and other changeable control conditions to observe different results.
#import <[webp/demux.h](https://raw.githubusercontent.com/XiangFan49/AME520Fall2022/main/Assignment/Final%20Project/Scene%20Reference.webp?token=GHSAT0AAAAAAB3SKE3P4FBJIT54MGD4JLRQY4LFWBA)>
https://raw.githubusercontent.com/XiangFan49/AME520Fall2022/main/Assignment/Final%20Project/Scene%20Reference.webp?token=GHSAT0AAAAAAB3SKE3P4FBJIT54MGD4JLRQY4LFWBA
