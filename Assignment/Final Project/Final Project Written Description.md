...
* In this process, the motion capture part will be performed by the VR device and represented by the data set generated by the AI ​​machine learning algorithm. In this way, although part of the accuracy of motion capture is lost, it gives participants more space for free movement. On the other hand, the preset digital scene will be a street with a slope, and the environmental hints in it will make the participants think they are traveling in a plane. We can match it to the situation in the physical environment or make parallel comparisons and other changeable control conditions to observe different results.
